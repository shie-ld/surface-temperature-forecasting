...
Surface Temperature Forecasting is a repository for forecasting surface temperature
...
If you like this repository, give it a star, or fork it and contribute!
...
```sh
wget https://raw.githubusercontent.com/shie-ld/surface-temperature-forecasting/master/parametricscheme.py
python parametricscheme.py -h
```
